...
export class AuthService {
  static async login(usernameOrEmail: string, plainPassword: string) {
    ...
    const isDemoAdmin =
      (cleanIdentifier === 'admin' || cleanIdentifier === 'admin@railmark.ai' || cleanIdentifier === 'admin@railmark.demo') &&
    ...
    const isDemoInspector =
      (cleanIdentifier === 'inspector' || cleanIdentifier === 'inspector@railmark.ai' || cleanIdentifier === 'inspector@railmark.demo') &&
